...
/**
 * Button — mirrors the Design System's Button component
 * (variants: default/secondary/destructive/outline/ghost/link; sizes: default/sm/lg/icon).
 * The primary (default) variant uses indigo-600 per the DS spec.
 */
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-indigo-600 text-white shadow-xs hover:bg-indigo-600/90 active:bg-indigo-700",
        secondary:
