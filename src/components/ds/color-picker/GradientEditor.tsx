...
import { sortStops, swapStopColors } from "./gradient";
...
/**
 * Gradient editor — matches the Figma "Gradient" tab: Solid/Gradient selector
 * with swap + reverse actions, a gradient canvas, an interactive stop track,
 * and the editable Stops list. Reuses the existing gradient hook/utilities;
    ...
    <div className={cn("flex flex-col gap-4", className)}>
      <div className="flex flex-col gap-2.5">
        ...
        >
          ...
          <span aria-hidden className="absolute inset-0" style={{ backgroundImage: css }} />
        </div>
